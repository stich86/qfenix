...
/*
 * Like attr_as_unsigned(), but returns @def when the attribute is absent
 * instead of flagging an error.  Used for attributes that are optional in
 * some autogenerated rawprogram/patch XMLs — e.g. physical_partition_number,
 * which Qualcomm tools omit when it is 0.
 */
